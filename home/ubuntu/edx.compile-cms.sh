...
if [ -f "$COMPILER_LOCK" ]; then
  ...
  echo
  echo "A Compile Assets process is currently running. Exiting"
...
echo "
  ...
  --------------------------------------------------------------
"
paver update_assets cms --settings=aws --theme-dirs /edx/app/edxapp/edx-platform/themes --themes=klapaacademy
