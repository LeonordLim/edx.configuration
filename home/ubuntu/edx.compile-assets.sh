...
| |__| (_) | | | | | | |_) | | |  __/ |_____| | |___| |  | |___) |
 \____\___/|_| |_| |_| .__/|_|_|\___|         |_____|_|  |_|____/
  ...
  --------------------------------------------------------------
"
paver --quiet update_assets lms --settings=aws --theme-dirs /edx/app/edxapp/edx-platform/themes --themes=klapaacademy
...
| |__| (_) | | | | | | |_) | | |  __/ |_____|  ___) | |_| |_| | (_| | | (_) |
 \____\___/|_| |_| |_| .__/|_|_|\___|         |____/ \__|\__,_|\__,_|_|\___/
  ...
  --------------------------------------------------------------
"
paver --quiet update_assets cms --settings=aws --theme-dirs /edx/app/edxapp/edx-platform/themes --themes=klapaacademy
...
| |__| (_) | | | | | | |_) | | |  __/ |_____| | |___| |  | |___) |
 \____\___/|_| |_| |_| .__/|_|_|\___|         |_____|_|  |_|____/
  ...
  --------------------------------------------------------------
"
paver compile_sass --system=lms --theme-dirs /edx/app/edxapp/edx-platform/themes --themes=klapaacademy
...
| |__| (_) | | | | | | |_) | | |  __/ |_____|  ___) | |_| |_| | (_| | | (_) |
 \____\___/|_| |_| |_| .__/|_|_|\___|         |____/ \__|\__,_|\__,_|_|\___/
  ...
  --------------------------------------------------------------
"
paver compile_sass --system=cms --theme-dirs /edx/app/edxapp/edx-platform/themes --themes=klapaacademy
