...
rm -rf /home/ubuntu/edx.configuration
git clone https://github.com/Klapaacademy/edx.configuration.git
...
sudo rm -r /edx/app/edxapp/edx-platform/themes/klapaacademy
sudo cp -R /home/ubuntu/edx.configuration/themes/klapaacademy /edx/app/edxapp/edx-platform/themes/
